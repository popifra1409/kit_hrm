...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hospital-name { font-size: 8px; font-weight: bold; color: #004d00; text-transform: uppercase; }
        .card-title { font-size: 7px; color: #666; margin-top: 1px; }

        .flags { position: absolute; top: 15px; }
        .flag-left { left: 3px; }
        .flag-right { right: 3px; }
        .flag-img { width: 12mm; height: auto; opacity: 0.8; }

        .card-body { padding: 15px 5px 5px 5px; display: table; width: 100%; }

        .photo-section { display: table-cell; width: 25mm; vertical-align: top; padding-right: 3px; }
        .photo { width: 22mm; height: 28mm; border: 1.5px solid #004d00; object-fit: cover; display: block; }

        .info-section { display: table-cell; vertical-align: top; padding-left: 2px; }
        .info-row { margin-bottom: 1.5mm; font-size: 7px; line-height: 1.2; }
        .info-label { font-weight: bold; color: #004d00; display: inline-block; width: 20mm; }
        .info-value { color: #333; font-weight: 600; }

        .qr-section { display: table-cell; width: 18mm; vertical-align: top; text-align: center; padding-left: 2px; }
        .qr-code { width: 15mm; height: 15mm; border: 1px solid #ddd; }
        .card-number { font-size: 5px; color: #666; margin-top: 1mm; font-weight: bold; }

        .footer { position: absolute; bottom: 2px; left: 5px; right: 5px; display: table; width: calc(100% - 10px); }
        .signature-section { display: table-cell; width: 34%; text-align: left; }
        .issue-section { display: table-cell; width: 33%; text-align: center; }
        .validity-section { display: table-cell; width: 33%; text-align: right; }

        .signature-label, .validity-label, .issue-label { font-size: 5px; color: #666; margin-bottom: 1px; }
        .signature-img { width: 15mm; height: auto; max-height: 6mm; }
        .validity-date, .issue-date { font-size: 6px; font-weight: bold; color: #004d00; }

        .watermark {
            position: absolute; top: 50%; left: 50%;
            transform: translate(-50%, -50%) rotate(-45deg);
            font-size: 25px; color: rgba(0, 77, 0, 0.05);
